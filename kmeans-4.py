...
centroid = [
                    {'x':20.0, 'y':10.0, 'cluster':'c1'},
                    {'x':40.0, 'y':60.0, 'cluster':'c2'},
                    {'x':70.0, 'y':20.0, 'cluster':'c3'},
                    {'x':90.0, 'y':50.0, 'cluster':'c4'},
...
for i in range(0, 1000):
    ...
    temp_random_cluster = {'x':temp_cluster_x, 'y':temp_cluster_y, 'cluster':''}
    data_cluster.append(temp_random_cluster)
