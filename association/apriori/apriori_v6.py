...
files = open('data/'+file_data[0]+'.txt', 'r')
...
while temp_selected_rules != {}:
	...
	for rules in temp_selected_rules:
		for rules_2 in temp_selected_rules_2:
			temp_comb_item_list.append(temp_selected_rules[rules]['item_set'] + temp_selected_rules_2[rules_2]['item_set'])
	
	print temp_comb_item_list

	for temp_comb_item in temp_comb_item_list:
